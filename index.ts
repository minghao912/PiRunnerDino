...
// Globals
const PI1000 = "3141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117067\
...
function dinoJump(keyPressed: string) {
    if (gameIsOver)
        return;

    let numPressed = parseInt(keyPressed);
    if (numPressed == NaN)
        return;
...
let isAlive = setInterval(function() {
    ...
    // Get positions
    let dinoTop: number = parseInt(window.getComputedStyle(dino).getPropertyValue("top"));
    let cactusLeft: number = parseInt(window.getComputedStyle(cactus).getPropertyValue("left"));
